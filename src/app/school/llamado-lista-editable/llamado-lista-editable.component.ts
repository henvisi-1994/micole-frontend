...
@Component({
  selector: "app-llamado-lista-editable",
  templateUrl: "./llamado-lista-editable.component.html",
  styleUrls: ["./llamado-lista-editable.component.scss"],
})
export class LlamadoListaEditableComponent implements OnInit {
  materias: Materia[] = [];
  grados: Grado[] = [];
