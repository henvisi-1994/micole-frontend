...
@Component({
  selector: "app-observacion-evidencia",
  templateUrl: "./observacion-evidencia.component.html",
  styleUrls: ["./observacion-evidencia.component.scss"],
})
export class ObservacionEvidenciaComponent implements OnInit {
