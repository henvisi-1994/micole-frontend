...
import { UpdateDailyRollCallComponent } from "src/app/school/update-daily-roll-call/update-daily-roll-call.component";
import { EditAttendanceComponent } from "src/app/school/update-daily-roll-call/edit-attendance/edit-attendance.component";
...
const appRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: "update-daily-roll-call",
        children: [
          {
            path: "",
            component: UpdateDailyRollCallComponent,
           // resolve: { user: UserByResolver },
          },  {
            path: "user/:id",
